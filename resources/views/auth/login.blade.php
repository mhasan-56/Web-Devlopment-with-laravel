                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="{{route('login')}}" method='POST'>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input name="email" class="form-control @error('email') is-invalid @enderror" type="email" id="emailaddress"   placeholder="Enter your email">
                                @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input name='password' class="form-control @error('password') is-invalid @enderror" type="password"  id="password" placeholder="Enter your password">
                                    @error('password')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group mb-3">
                                <div class="">
                                    <input {{ old('remember') ? 'checked' : '' }} class="form-check-input" name='remember' type="checkbox" id="checkbox-signin" checked>
